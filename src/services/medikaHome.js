export const apiData = {
  ...
  lastUpdate: "2024-12-12T15:00:00Z",
  websiteName: "Medika Home",
  domain: "medikahome",
  domainExtension: ".com.mx",
  affiliatedEmails: [
    {
      email: "contact@medikahome.com",
      lastUpdate: "2024-12-09T13:00:00Z",
      personName: "Dr. Elena Soto",
    },
  ],
  daysLeft: -25,
  whatsappChat: true,
  ...
  home: {
    ...
    companyInfo: {
      aboutUs: {
        title: "Nosotros",
        description:
          "Nuestro consultorio médico esta diseñado para brindar atención profesional, accesible y cercana a cada paciente. Ofrecemos consultas médicas orientadas a cuidar tu bienestar con un enfoque humano y responsable, asegurando una experiencia cómoda desde el primer contacto.",
      },
    },
  },
  products: {
